...
export default function Home() {
  ...
  const logoData = [
    { id: 1,  image: "/images/logo/logo1.png" },
    { id: 2,  image: "/images/logo/logo1.png" },
    { id: 3,  image: "/images/logo/logo1.png" },
    { id: 4,  image: "/images/logo/logo1.png" },
    { id: 5,  image: "/images/logo/logo1.png" },
    { id: 6,  image: "/images/logo/logo1.png" },
    { id: 7,  image: "/images/logo/logo1.png" },
    { id: 8,  image: "/images/logo/logo1.png" },
    { id: 9,  image: "/images/logo/logo1.png" },
    { id: 10, image: "/images/logo/logo1.png" },
    { id: 11, image: "/images/logo/logo1.png" },
    { id: 12, image: "/images/logo/logo1.png" },
];
    ...
    <div className="max-w-[90%] mx-auto">
      <div className="flex gap-6">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="space-y-10 max-w-[1040px]">
            ...
            <div className="rounded-xl p-4 bg-gray-50 border border-gray-200 w-full">
              ...
              <div className="relative">
                ...
                <div ref={scrollRef1} onScroll={handleScroll1} className="overflow-x-auto scroll-smooth">
            ...
            <div className="rounded-xl p-4 bg-pink-50 border border-pink-200 w-full">
              ...
              <div className="relative">
                ...
                <div ref={scrollRef2} onScroll={handleScroll2} className="overflow-x-auto scroll-smooth">
                  <div className="flex gap-4 w-max flex-row-reverse">
                    {featuredBooks.map((p) => (
            ...
            <div className="space-y-10 max-w-[1040px] mx-auto">
               <LogoGrid logos={logoData} />
                ...
                {/* Gợi ý hôm nay */}
<div className="space-y-2 max-w-[1040px] mx-auto">
  <h2 className="text-lg font-semibold">Gợi ý hôm nay</h2>
  <IconBar icons={suggestionIcons} />
</div>
